...
export default function AddExpenseScreen() {
	...
	const { t } = useLanguage();
	const { addExpenseToFirestore, budgetState } = useBudget();
	...
	const handleAddExpense = async () => {
		...
		try {
			...
			// Await the Firestore write so dashboard updates immediately when we go back
			...
			<SafeAreaView style={{ flex: 1 }}>
				<KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={{ flex: 1 }}>
					<ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
						...
						{/* Submit */}
						<TouchableOpacity style={styles.submitButton} onPress={handleAddExpense} activeOpacity={0.85} disabled={isSaving}>
							<LinearGradient
